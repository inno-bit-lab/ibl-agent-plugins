...
- [x] Skill frontmatter preserved in canonical repo
- [x] Plugin manifest validated
- [x] Repo validator passed
- [x] Candidate changes compared against Claude Code source copy
