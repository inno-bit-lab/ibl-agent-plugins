...
and emits a test file under the appropriate test project. The baseline tests
(list / create / validation) are always included; lifecycle/multitenancy/bulk
test blocks are emitted based on flags or auto-detected from the AppService.
